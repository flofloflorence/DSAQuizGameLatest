...
import Test.QuestionQueue;
import Test.QuizQuestion;
import Test.AnswerStack;
...
public class PerformanceAnalyzer {
    public static long timeAddQueue(int n) {
        ...
        for (int i = 0; i < n; i++)
            q.enqueue(new QuizQuestion("U" + i, "", "", "", "", 1));
...
// this is a simple implementation of a PerformanceAnalyzer class for measuring performance of data structure operations